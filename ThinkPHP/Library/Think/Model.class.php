...
class Model {
     ...
     */
     public function create($data='',$type='') {
        ...
        if(!$this->autoValidation($data,$type)){
           // file_put_contents("d:/WWW/wy_erp/mylog.log","thinkphp/library/think/model.class.php: autoValidation error:"."\r\n",FILE_APPEND);
            return false;
        }
        ...
        if(!$this->autoCheckToken($data)) {
            ...
            //file_put_contents("d:/WWW/wy_erp/mylog.log","thinkphp/library/think/model.class.php: autoCheckToken error:"."\r\n",FILE_APPEND);
    ...
    protected function autoValidation($data,$type) {
     //   file_put_contents("d:/WWW/wy_erp/mylog.log","thinkphp/library/think/model.class.php:autoValidation:"."\r\n",FILE_APPEND);
        if(!empty($this->options['validate'])) {
            $_validate   =   $this->options['validate'];
            unset($this->options['validate']);
           // file_put_contents("d:/WWW/wy_erp/mylog.log","thinkphp/library/think/model.class.php:options['validate']:"."\r\n",FILE_APPEND);

        }elseif(!empty($this->_validate)){
            $_validate   =   $this->_validate;
           // file_put_contents("d:/WWW/wy_erp/mylog.log","thinkphp/library/think/model.class.php:_validate:"."\r\n",FILE_APPEND);
        ...
        if(isset($_validate)) { // 如果设置了数据自动验证则进行数据验证
            if($this->patchValidate) { // 重置验证错误信息
                $this->error = array();
              //  file_put_contents("d:/WWW/wy_erp/mylog.log","thinkphp/library/think/model.class.php:error:"."\r\n",FILE_APPEND);
